...
<nav x-data="{ open: false }" class="bg-white bg-gray-800 border-b border-gray-100 border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Cover Letter Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('CoverLetter')" :active="request()->routeIs('CoverLetter')" wire:navigate>
                        Cover Letter
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 text-gray-200" x-data="{ name: '{{ auth()->user()->name }}' }" x-text="name" x-on:profile-updated.window="name = $event.detail.name"></div>
