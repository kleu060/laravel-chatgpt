...
Route::middleware(['auth', 'verified', 'checkChatGPT'])->group(function () {
    Route::get('/coverletter',[App\Http\Controllers\CoverLetterController::class, 'index'])->name("CoverLetter");
    Route::post('/createPDF',[App\Http\Controllers\CoverLetterController::class, 'createPDF'])->name("createPDF");
